    ...
    return (
      ...
      >
        ...
        <div class="connect_popup">
                    ...
                    <p>This information will be shared with the Supplier</p>
                    <div class="quot_frm">
                        <div class="frm_grp">
                        ...
                        <div class="frm_grp">
                            ...
                            <p class="Manuf_notif"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12 7C11.0111 7 10.0444 7.29324 9.22215 7.84265C8.3999 8.39206 7.75904 9.17295 7.3806 10.0866C7.00217 11.0002 6.90315 12.0055 7.09608 12.9755C7.289 13.9454 7.76521 14.8363 8.46447 15.5355C9.16373 16.2348 10.0546 16.711 11.0245 16.9039C11.9945 17.0969 12.9998 16.9978 13.9134 16.6194C14.827 16.241 15.6079 15.6001 16.1573 14.7778C16.7068 13.9556 17 12.9889 17 12C16.9986 10.6743 16.4714 9.40339 15.534 8.46601C14.5966 7.52863 13.3257 7.0014 12 7ZM12 16.2308C11.1632 16.2308 10.3453 15.9826 9.64951 15.5178C8.95377 15.0529 8.4115 14.3921 8.09128 13.619C7.77106 12.846 7.68728 11.9953 7.85053 11.1746C8.01377 10.3539 8.41671 9.60008 9.0084 9.00839C9.60008 8.41671 10.3539 8.01377 11.1746 7.85052C11.9953 7.68728 12.846 7.77106 13.619 8.09128C14.3921 8.4115 15.0529 8.95376 15.5178 9.64951C15.9826 10.3453 16.2308 11.1632 16.2308 12C16.2295 13.1217 15.7833 14.1971 14.9902 14.9902C14.1971 15.7833 13.1217 16.2295 12 16.2308ZM15.0769 12C15.0769 12.6086 14.8965 13.2034 14.5584 13.7094C14.2203 14.2154 13.7397 14.6098 13.1775 14.8427C12.6153 15.0756 11.9966 15.1365 11.3997 15.0178C10.8029 14.8991 10.2546 14.606 9.82429 14.1757C9.39397 13.7454 9.10092 13.1971 8.9822 12.6003C8.86348 12.0034 8.92441 11.3847 9.1573 10.8225C9.39018 10.2603 9.78456 9.77973 10.2906 9.44163C10.7966 9.10353 11.3914 8.92308 12 8.92308C12.8158 8.92397 13.5979 9.24843 14.1747 9.82527C14.7516 10.4021 15.076 11.1842 15.0769 12Z" fill="#4CA209"/>
                              </svg></span>Send to Manufacturer</p>
                        ...
                        <div class="frm_grp">
                            <label for="">Unit of Product</label>
                            <input type="text" name="" id="" placeholder="60" class="form-control" />
                        </div>
                        <div class="frm_grp arrow_select">
                            <label for="">Product Name</label>
                            <select name="" id="" class="form-control">
                                <option value="">Cuir Handbag</option>
                            </select>
                        </div>
                        
                        <div class="frm_grp">
                            <label for="">Colour</label>
                            <input type="text" name="" id="" placeholder="Chestnut Brown" class="form-control" />
                        </div>
                        ...
                        <div class="frm_grp">
                            ...
                            <input type="text" name="" id=""  class="form-control" placeholder="15 Days" />
                        </div>
                        <div class="frm_grp">
                            <label for="">Items Checklist</label>
                            <div class="frm_upload">
                                <a href="#">Document.pdf</a>
                                <div class="upload_bx">
                                    <input type="file" class="form-control" placeholder="Document.pdf" id="Upload" />
                                    <label for="Upload" class="Verified_btn"> Upload</label>
  ...
  function MyVerticallyCenteredModal2(props) {
    return (
      ...
      >
        ...
        <div class="connect_popup">
                    <h3>Request for Quotation</h3>
                    <p>This information has been shared to the Manufacturer.</p>
                    <div class="quot_frm">
                        <div class="frm_grp">
                            <label for="">SPOC Name</label>
                            <input type="text" name="" id="" placeholder="Alex Cooper" class="form-control"/>
                        ...
                        <div className="page-body-wrapper">
                            <nav className="sidebar sidebar-offcanvas" id="sidebar">
                                ...
                                <ul className="nav">
                                    ...
                                    <li className="nav-item ">
                                        <Link to={"/DesignerProfile/TheProfile"} className="nav-link">
                                            <span className="icon-bg">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25"
                                                    viewBox="0 0 24 25" fill="none">
                                                    <path
                                    ...
                                    <li className="nav-item menu_toggle  menu_open nav-active">
                                        ...
                                        <ul className="nk-menu-sub">
                                            <li className='active'> <Link to={"/DesignerProfile/Rfq"} > -- Raised RFQ</Link></li>
                                            <li > <Link to={"/DesignerProfile/ReceivedQuotation"}>-- Received Quotation</Link></li>
                                        </ul>
                                    </li>
