    ...
    return (
      ...
      >
        ...
        <div class="connect_popup">
                    ...
                    <p>This information has been shared by the Supplier.</p>
                    <div class="quot_frm">
                        <div class="frm_grp">
                            <label for="">SPOC Name</label>
                            <input type="text" name="" id="" placeholder="John Thomas" class="form-control"/>
                        </div>
                        <div class="frm_grp">
                            <label for="">Email ID</label>
                            <input type="text" name="" id="" placeholder="johnthomas@gmail.com" class="form-control"/>
                        </div>
                        <div class="frm_grp">
                            <label for="">Mobile Number</label>
                            <input type="text" name="" id="" placeholder="665 183 4627" class="form-control"/>
                        </div>
                        <div class="frm_grp">
                            <label for="">Billing Address</label>
                            <input type="text" name="" id="" placeholder="Modern Suites No. 187, Toronto" class="form-control"/>
                        </div>
                        <div class="frm_grp">
                        ...
                        <div class="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="400 CAD" class="form-control"/>
                        </div>
                        <div class="frm_grp arrow_select">
                            <label for="">Quantity </label>
                            <select name="" id="" class="form-control">
                                <option value="">12 sq ft</option>
                            </select>
                        </div>
                    ...
                    <div class="btn_grp_com">
                        <button class="btn bg_btn">Confirm and Pay</button>
                    </div>
...
export const ReceivedQuotation = () => {
                ...
                <div className="flare__grid">
                    ...
                    <div class="dashboard_inner">
                        <div class="heading_bx">
                            <h3>rFQ Recieved Quotation</h3>
                            
                        </div>
                      
                        <div class="task_frm form_table">
                        <div class="tabel_scoller">
                            <table class="table">
                                <thead><tr>
                                    <th>Request ID</th>
                                    <th>Product Name</th>
                                    ...
                                    <tr class="active">
                                        ...
                                        <td>
                                            <div class="btn_grp">
                                                ...
                                                <button class="btn"  onClick={() => setModalShow(true)} data-bs-toggle="modal" data-bs-target="#Quotation02">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                        <g clip-path="url(#clip0_15840_2124)">
                                                          <path d="M17.3508 8.13861C17.564 8.37486 17.682 8.68179 17.682 9.00003C17.682 9.31828 17.564 9.62521 17.3508 9.86146C16.0008 11.3143 12.9279 14.1429 9.34076 14.1429C5.75362 14.1429 2.68076 11.3143 1.33076 9.86146C1.11754 9.62521 0.999512 9.31828 0.999512 9.00003C0.999512 8.68179 1.11754 8.37486 1.33076 8.13861C2.68076 6.68575 5.75362 3.85718 9.34076 3.85718C12.9279 3.85718 16.0008 6.68575 17.3508 8.13861Z" stroke="#1086B4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                          <path d="M9.57143 11.5714C10.9916 11.5714 12.1429 10.4202 12.1429 9.00002C12.1429 7.57986 10.9916 6.42859 9.57143 6.42859C8.15127 6.42859 7 7.57986 7 9.00002C7 10.4202 8.15127 11.5714 9.57143 11.5714Z" stroke="#1086B4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
