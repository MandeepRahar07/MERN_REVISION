                    ...
                    <div className="dashboard_inner">
                        ...
                        <div className="order_card">
                            <div className="row">
                                        ...
                                        <div className="card_ord">
                                            ...
                                            <div className="cont_bx">
                                                <div className="lft_bx">
                                                    ...
                                                    <p>Manufacturer: Giovanni RawHides</p>
                                                </div>
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <div className="Invoice_wrapp">
                                        <h3>Invoice No: 0508567</h3>
                                        <p>Total Paid: CAD 1,200</p>
                                        <button className="btn">Payment Details</button>
                                        <h4><span>Amount</span><span>$ 1,140</span></h4>
                                        <h4><span>Tax (5%)</span><span>$ 60</span></h4>
                                        <h4><span>Payment Mode</span><span>Visa</span></h4>
